...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null, sdf.parse("25/01/2023"), "Partiu Viagem!", "Vou viajar para Rio de Contas", pablo);
		Post post2 = new Post(null, sdf.parse("17/03/2023"), "Bom dia!", "Acordei feliz hoje!", pablo);
